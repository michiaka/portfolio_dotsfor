#ifndef __PROGTEST__ /*DONT CHANGE THE PLACE*/
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
#define MAX 100/*setting the value MAX*/
#endif /* __PROGTEST__ */
...
int main()
{
    ...
    char buffer[MAX];
    /*placing the input from stdin in to buffer and */
    fgets(buffer, MAX, stdin);
    /*converting into int and store them into variables*/
    sscanf(buffer, "%d %d %d %d %d %d %d %d %d %d", 
                               &y1, &m1, &d1, &h1, &i1, &y2, &m2, &d2, &h2, &i2);
...
#endif /* __PROGTEST__ */ /*DONT CHANGE THE PLACE*/
